...
from .views import product_detail_view, product_list_view, postad,product_list_view_elec,product_list_view_jobs,product_list_view_others,product_list_view_roomdecor,product_list_view_stationary,product_list_view_vehicles, delete_product
...
urlpatterns = [
    ...
    path("delete/<str:slug>/",delete_product, name = 'delete_product'),
]
